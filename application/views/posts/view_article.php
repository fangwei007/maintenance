<ol class="breadcrumb">
    <li><a href="#"><?= lang($post->Category) . lang('article')?></a></li>
    <li class="active"><?= $post->Title?></li>
</ol>
<div class="article-block">
    
<div class="article-title"><?= $post->Title?></div> 
<div class="author-date-bar clearfix">
    <ul>
...
<!--clarification-->		
<div class="clarification">本文章版权属于作者和<a href="/">比橙网</a>(bridgeous.com)，转载请注明出处，商用请<a href="#">联系比橙</a></div>
